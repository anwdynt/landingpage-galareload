        ...
        <div className="mx-auto max-w-sm px-4 py-8 md:py-12 lg:py-20 font-sans antialiased md:max-w-4xl md:px-8 lg:px-12">
            <div className="relative grid grid-cols-1 gap-20 md:grid-cols-2">
                ...
                <div className="flex flex-col justify-between py-4">
                    ...
                    >
                        <h3 className="lg:text-2xl text-xl font-bold text-black dark:text-white font-metropolis">
                            {testimonials[active].name}
                        </h3>
                        <p className="text-sm text-gray-500 dark:text-neutral-500 font-google-sans font-normal">
                            {testimonials[active].designation}
                        </p>
                        <motion.p className="mt-8 lg:text-lg text-base text-primary font-light dark:text-neutral-300 font-google-sans">
